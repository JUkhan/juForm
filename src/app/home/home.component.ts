                        ...
                        type: 'groupLayout', items: [
                            [{
                                groupName: 'Group-1', size: 8, inputs: [
                                    ...
                                    { field: 'Gender', label: 'Gender', type: 'juSelect', data:[{name:'Male', value:1},{name:'Female', value:2}] },
                            ...
                            [{
                                groupName: 'Group-3', tabs: {
                                    Oxygen: [
                                        { field: 'oxygen', label: 'Oxygen', type: 'text' }

                                    ],
                                    h20: [
                                        { field: 'h20', label: 'H20', type: 'text' },
                                        {
                                            tabConfig: true, enable: (form, model) => {
                                                return !!model.oxygen;
                                            }
                                        }
                                    ]
                ...
                'Tab-2': [
                    ...
                    field: 'products', type: 'detail', detailInfo: '<b>Detail Info or action button if needed</b>', search: true, options: {
                        ...
                        inputs: [[
                            ...
                            { field: 'Thana', size: 3, type: 'juSelect', validators: FV.required }
                        ]],
                        remove: (model) => {
